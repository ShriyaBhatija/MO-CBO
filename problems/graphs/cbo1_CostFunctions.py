...
def cost_Z1_fix_equal(intervention_value, **kwargs):
    fix_cost = 1.
    return fix_cost

def cost_Z2_fix_equal(intervention_value, **kwargs):
    fix_cost = 1.
    return fix_cost
...
def cost_Z1_fix_different(intervention_value, **kwargs):
    fix_cost = 2.
    return fix_cost

def cost_Z2_fix_different(intervention_value, **kwargs):
    fix_cost = 5.
    return fix_cost
...
def cost_Z1_fix_different_variable(intervention_value, **kwargs):
    fix_cost = 2.
    return np.sum(np.abs(intervention_value)) + fix_cost

def cost_Z2_fix_different_variable(intervention_value, **kwargs):
    fix_cost = 5.
    return np.sum(np.abs(intervention_value)) + fix_cost
...
def cost_Z1_fix_equal_variable(intervention_value, **kwargs):
    fix_cost = 1.
    return np.sum(np.abs(intervention_value)) + fix_cost

def cost_Z2_fix_equal_variable(intervention_value, **kwargs):
    fix_cost = 1.
    return np.sum(np.abs(intervention_value)) + fix_cost
...
def define_costs(type_cost):
    if type_cost == 1:
        ...
        ('Z1', cost_Z1_fix_equal),
        ('Z2', cost_Z2_fix_equal),
    ...
    if type_cost == 2:
        ...
        ('Z1', cost_Z1_fix_different),
        ('Z2', cost_Z2_fix_different),
    ...
    if type_cost == 3:
        ...
        ('Z1', cost_Z1_fix_different_variable),
        ('Z2', cost_Z2_fix_different_variable),
    ...
    if type_cost == 4:
        ...
        ('Z1', cost_Z1_fix_equal_variable),
        ('Z2', cost_Z2_fix_equal_variable),
