...
def get_args():
    ...
    parser.add_argument('--mis', type=str, default = 'X1X2', help='minimal intervention set')
    ...
    for pid, problem in enumerate(problems):
        ...
        for i, algo in enumerate(algos.keys()):
            for seed in range(n_seed):
                csv_path = f'{problem_dir}/{algo}/{args.mis}/EvaluatedSamples.csv'
