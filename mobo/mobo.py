...
class MOBO:
    ...
    def __init__(self, problem, mis, n_iter, ref_point, framework_args):
        '''
        Input:
    ...
    def solve(self, X_init, Y_init):
        ...
        for i in range(self.n_iter):
            ...
            yield X_next, Y_next, initial_hv, self.status['hv']
