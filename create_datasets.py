...
parser.add_argument('--experiment', default = 'cbo3', type = str, help = 'experiment')
parser.add_argument('--type', default='observational', type=str, help='type of samples')
...
pathlib.Path('Data/' + str(args.experiment)).mkdir(parents=True, exist_ok=True)


if experiment == 'cbo1':
    observational_samples = OrderedDict([('X1', []), ('X2', []), ('Z1', []), ('Z2', []), ('Y1', []), ('Y2', [])])
...
if type == 'observational':
    ...
    observational_samples.to_pickle('./Data/' + str(args.experiment) + '/' + 'observations.pkl', protocol=4)
...
if type == 'interventional':
    ...
    np.save('./Data/' + str(args.experiment) + '/' + f'interventional_data.npy', interventional_data)