...
def get_general_args(args=None):
    ...
    parser.add_argument('--exp-set', type=str, default='mobo', choices=['mo-cbo', 'mis', 'mobo'], 
...
def get_solver_args(args=None):
    ...
    parser.add_argument('--solver', type=str, 
        choices=['nsga2', 'moead', 'discovery'], default='discovery', 
    ...
    parser.add_argument('--pop-init-method', type=str, 
        choices=['nds', 'random', 'lhs'], default='random', 
